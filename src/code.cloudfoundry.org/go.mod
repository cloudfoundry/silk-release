...
require (
	...
	code.cloudfoundry.org/diego-logging-client v0.0.0-20240403132506-4e6d96d497d1
	...
	code.cloudfoundry.org/policy_client v0.0.0-20240401155427-8c21adbc5be9
...
require (
	code.cloudfoundry.org/bbs v0.0.0-20240401230014-ed87f495edc2 // indirect
	...
	code.cloudfoundry.org/tlsconfig v0.0.0-20240403132441-f9f6ab7c839e // indirect
