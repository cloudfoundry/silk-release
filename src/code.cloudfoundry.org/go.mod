...
require (
	...
	code.cloudfoundry.org/diego-logging-client v0.23.0
	...
	code.cloudfoundry.org/policy_client v0.22.0
...
require (
	code.cloudfoundry.org/bbs v0.0.0-20241008170404-8f119d532056 // indirect
